...
def generate_main_menu():
    return ReplyKeyboardMarkup(keyboard=[
        ...
        [KeyboardButton(text='История 📖'), KeyboardButton(text='Корзина 🛒'), KeyboardButton(text='Настройки ⚙️')]
    ], resize_keyboard=True, one_time_keyboard=True)


def generate_category_menu():
    markup = InlineKeyboardMarkup(inline_keyboard=[])
    markup.inline_keyboard.append([InlineKeyboardButton(text='Наше меню', url='https://telegra.ph/Our-menu-10-08-2')])
